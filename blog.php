            ...
            <div class="blog-card-group">
              <article class="blog-card">
                ...
                <div class="blog-content-wrapper">
                  ...
                  <h3>
                    <a href="#" class="h3">
                      Over 90,000 “RAMinator” downloads
                    </a>
                  </h3>

                  <p class="blog-text">
                    For more than 5 years our popular in-house analysis tool for
                    determining system information for a RAM upgrade is
              ...
              <article class="blog-card">
                ...
                <div class="blog-content-wrapper">
                  <button class="blog-topic text-tiny">SSD</button>
                  ...
                  <p class="blog-text">
                    Samsung offers a variety of SSD, but what are the
                    differences? And which SSD is best for which requirements?
                    Our...
                  </p>
                  ...
                  <div class="wrapper-flex">
                    <div class="wrapper">
                      <p class="text-sm">
                        <time datetime="2022-01-17">Jan 17, 2021</time>
                        <span class="separator"></span>
                        <ion-icon name="time-outline"></ion-icon>
                        <time datetime="PT3M">3 min</time>
                      </p>
